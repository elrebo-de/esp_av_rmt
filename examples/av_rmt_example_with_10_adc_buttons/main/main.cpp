...
uint8_t deepSleepDelay = 30;
// count down for DeepSleep
uint8_t deepSleepCountDown = deepSleepDelay;
...
extern "C" void callback_onBoardButton_BUTTON_SINGLE_CLICK(void *arg, void *data)
{
    ...
    switch(buttonIndex) {
        case 9:
            // buttonIndex == 9: decrement volume
            avRmt->decrementVolume();
            break;
        case 8:
            // buttonIndex == 8: increment volume
            avRmt->incrementVolume();
            break;
        case 7:
            // buttonIndex == 7: switch on YAMAHA receiver for listening to the Radio
    ...
    finished = true;
    deepSleepCountDown = deepSleepDelay;
}
...
extern "C" void app_main(void)
{
    ...
    button_adc_config_t btn_adc_cfg_0 = {
        ...
        .max = 89,                          /**< max voltage in mv corresponding to the button */
    };
    ...
    button_adc_config_t btn_adc_cfg_1 = {
        ...
        .min = 90,                          /**< min voltage in mv corresponding to the button */
        .max = 267,                          /**< max voltage in mv corresponding to the button */
    };
    ...
    button_adc_config_t btn_adc_cfg_2 = {
        ...
        .min = 268,                          /**< min voltage in mv corresponding to the button */
        .max = 440,                         /**< max voltage in mv corresponding to the button */
    };
    ...
    button_adc_config_t btn_adc_cfg_3 = {
        ...
        .min = 441,                         /**< min voltage in mv corresponding to the button */
        .max = 611,                         /**< max voltage in mv corresponding to the button */
    };
    ...
    button_adc_config_t btn_adc_cfg_4 = {
        ...
        .min = 612,                         /**< min voltage in mv corresponding to the button */
        .max = 784,                         /**< max voltage in mv corresponding to the button */
    };
    ...
    button_adc_config_t btn_adc_cfg_5 = {
        ...
        .min = 785,                         /**< min voltage in mv corresponding to the button */
        .max = 959,                         /**< max voltage in mv corresponding to the button */
    };

    // adcButton6
    button_adc_config_t btn_adc_cfg_6 = {
        .adc_handle = adc_handle,           /**< handle of adc unit, if NULL will create new one internal, else will use the handle */
        .unit_id = ADC_UNIT_1,               /**< ADC unit */
        .adc_channel = ADC1_GPIO0_CHANNEL,   /**< Channel of ADC */
        .button_index = 6,                   /**< button index on the channel */
        .min = 960,                         /**< min voltage in mv corresponding to the button */
        .max = 1132,                         /**< max voltage in mv corresponding to the button */
    };

    // adcButton7
    button_adc_config_t btn_adc_cfg_7 = {
        .adc_handle = adc_handle,           /**< handle of adc unit, if NULL will create new one internal, else will use the handle */
        .unit_id = ADC_UNIT_1,               /**< ADC unit */
        .adc_channel = ADC1_GPIO0_CHANNEL,   /**< Channel of ADC */
        .button_index = 7,                   /**< button index on the channel */
        .min = 1133,                         /**< min voltage in mv corresponding to the button */
        .max = 1306,                         /**< max voltage in mv corresponding to the button */
    };

    // adcButton8
    button_adc_config_t btn_adc_cfg_8 = {
        .adc_handle = adc_handle,           /**< handle of adc unit, if NULL will create new one internal, else will use the handle */
        .unit_id = ADC_UNIT_1,               /**< ADC unit */
        .adc_channel = ADC1_GPIO0_CHANNEL,   /**< Channel of ADC */
        .button_index = 8,                   /**< button index on the channel */
        .min = 1307,                         /**< min voltage in mv corresponding to the button */
        .max = 1479,                         /**< max voltage in mv corresponding to the button */
    };

    // adcButton9
    button_adc_config_t btn_adc_cfg_9 = {
        .adc_handle = adc_handle,           /**< handle of adc unit, if NULL will create new one internal, else will use the handle */
        .unit_id = ADC_UNIT_1,               /**< ADC unit */
        .adc_channel = ADC1_GPIO0_CHANNEL,   /**< Channel of ADC */
        .button_index = 9,                   /**< button index on the channel */
        .min = 1480,                         /**< min voltage in mv corresponding to the button */
        .max = 1649,                         /**< max voltage in mv corresponding to the button */
    };
    ...
    GenericButton adcButton6(std::string("adcButton6"), &btn_adc_cfg_6);
    adcButton6.RegisterCallbackForEvent(BUTTON_SINGLE_CLICK, callback_onBoardButton_BUTTON_SINGLE_CLICK, (void *)&btn_adc_cfg_6);

    GenericButton adcButton7(std::string("adcButton7"), &btn_adc_cfg_7);
    adcButton7.RegisterCallbackForEvent(BUTTON_SINGLE_CLICK, callback_onBoardButton_BUTTON_SINGLE_CLICK, (void *)&btn_adc_cfg_7);

    GenericButton adcButton8(std::string("adcButton8"), &btn_adc_cfg_8);
    adcButton8.RegisterCallbackForEvent(BUTTON_SINGLE_CLICK, callback_onBoardButton_BUTTON_SINGLE_CLICK, (void *)&btn_adc_cfg_8);

    GenericButton adcButton9(std::string("adcButton9"), &btn_adc_cfg_9);
    adcButton9.RegisterCallbackForEvent(BUTTON_SINGLE_CLICK, callback_onBoardButton_BUTTON_SINGLE_CLICK, (void *)&btn_adc_cfg_9);
    ...
    // go to DeepSleep
    do {
        ESP_LOGI(tag, "DeepSleepCountDown: %u", deepSleepCountDown);
        deepSleepCountDown--;
        vTaskDelay(pdMS_TO_TICKS(1000)); // delay 1 second
    } while (deepSleepCountDown > 0);
